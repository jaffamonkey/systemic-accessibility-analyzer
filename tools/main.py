...
https://example.com/contact"></textarea>
            ...
            <div class="section">
              ...
              <p>Note: On HTTP-only or legacy websites, some tools such as axe-scan and Pa11y-based checks may be less reliable. The job will continue, and any tool-specific failures will be shown in the results.</p>
              <p>If the website test need authentication then axe-scan will not run (only supports basic authentication).</p>
              ...
              <div class="tools">
                ...
                <label class="tool-item"><input type="checkbox" name="tools" value="nu-html-checker" checked /> nu html checker</label>
                <label class="tool-item"><input type="checkbox" name="tools" value="alfa" /> alfa</label>
                <label class="tool-item"><input type="checkbox" name="tools" value="speca11y" /> speca11y</label>
