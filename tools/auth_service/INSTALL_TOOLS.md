...
- **Reporting / analysis service** (`analyzer`)
...
```text
/Users/user/code/systemic-accessibility-analyzer/tools/auth_service
```
...
```text
/Users/user/code/systemic-accessibility-analyzer/analyzer
```
...
```bash
cd /Users/user/code/systemic-accessibility-analyzer/tools/auth_service
...
```bash
cd /Users/user/code/systemic-accessibility-analyzer/analyzer
...
curl -X POST "http://127.0.0.1:8001/jobs/example-job/run-full" \
  -H "Content-Type: application/json" \
  -d '{
    "job_config": "/Users/user/code/systemic-accessibility-analyzer/tools/auth_service/example_job_config.json",
    "analysis_repo_dir": "/Users/user/code/systemic-accessibility-analyzer/analyzer",
    "auth_service_dir": "/Users/user/code/systemic-accessibility-analyzer/tools/auth_service"
  }'
```
...
python run_job_analysis.py \
  --reports-dir /Users/user/code/systemic-accessibility-analyzer/tools/auth_service/jobs/example-job/reports \
  --output-dir /Users/user/code/systemic-accessibility-analyzer/tools/auth_service/jobs/example-job/analysis
```
...
Find your jobs DB:
```
find /Users/user/code/systemic-accessibility-analyzer/tools/auth_service -name "*.db"
```
